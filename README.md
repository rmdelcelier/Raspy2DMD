...
**Sur un Raspberry Pi avec Raspberry Pi OS Lite (64-bit) - Trixie minimum - déjà installé**
...
| Composant |  |
|-----------|---------|
| **Raspberry Pi** | Pi Zero 2W (ou plus)|
...
Les mises à jour sont **automatiques** et vérifiées quotidiennement.
